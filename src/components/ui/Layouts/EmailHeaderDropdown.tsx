...
const EmailHeaderDropdown = () => {
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownContent>
          <DropdownTitle>Email actions</DropdownTitle>
          <DropdownHr />
          <DropdownItem className="alignItem">
            ...
            <span style={{ width: '23px', height: '16px', fontSize: '12px', color: '#09090b', marginLeft: '84px' }}>
              ⌘D
            </span>
          </DropdownItem>
          <DropdownItem className="alignItem">
            ...
            <span style={{ width: '23px', height: '16px', fontSize: '12px', color: '#09090b', marginLeft: '58px' }}>
              ⌘T
            </span>
          </DropdownItem>
          <DropdownItem className="alignItem">
            ...
            <span style={{ width: '23px', height: '16px', fontSize: '12px', color: '#09090b', marginLeft: '102px' }}>
              ⌘␡
            </span>
          </DropdownItem>
        </DropdownContent>
